...
export function useGoogleIntegration() {
  ...
  const checkStatus = useCallback(async () => {
    ...
    try {
      ...
      const { data, error } = await supabase.functions.invoke('get-google-integration-status', {
  ...
  return { connected, loading, checkingStatus, connect, revoke, refetch: checkStatus }
}
