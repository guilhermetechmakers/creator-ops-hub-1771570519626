...
export interface TermsHighlightsProps {
  className?: string
}
...
const HIGHLIGHTS = [
  ...
  },
  {
    ...
    items: [
      ...
      'Platform usage governed by these terms',
      'AI tools used at your responsibility',
  ...
  },
  {
    ...
    title: 'Contact',
    items: [
      'legal@creatoropshub.com (Terms)',
      'privacy@creatoropshub.com (Privacy)',
      'Response within 30 days',
    ],
  },
]

export function TermsHighlights({ className }: TermsHighlightsProps) {
  return (
    <div
      className={cn(
