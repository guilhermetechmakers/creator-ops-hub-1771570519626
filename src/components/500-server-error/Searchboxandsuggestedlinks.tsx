          ...
          {links.map((link, i) => {
            ...
            return (
              <button
                ...
                className="flex items-center gap-3 px-4 py-3 rounded-xl text-left border border-border bg-card hover:border-primary/30 hover:bg-primary/5 transition-all duration-200 hover:scale-[1.02] hover:shadow-card-hover focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
