...
import { MessageServerErrorExplanation } from '@/components/500-server-error/MessageServerErrorExplanation'
import { Searchboxandsuggestedlinks } from '@/components/500-server-error/Searchboxandsuggestedlinks'
import { CTAGoToDashboardOrContactSupport } from '@/components/500-server-error/CTAGoToDashboardOrContactSupport'
import { cn } from '@/lib/utils'

export function ServerErrorPage() {
  useEffect(() => {
    document.title = '500 Server Error | Creator Ops Hub'
  }, [])
