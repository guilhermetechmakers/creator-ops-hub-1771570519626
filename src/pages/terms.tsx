...
import { FullTermsOfServiceText } from '@/components/terms-of-service/full-terms-of-service-text'
import { TermsHighlights } from '@/components/terms-of-service/terms-highlights'
import { TermsDownloadPrintOption } from '@/components/terms-of-service/download-print-option'

export function TermsPage() {
  const contentRef = useRef<HTMLDivElement>(null)

  useEffect(() => {
    document.title = 'Terms of Service | Creator Ops Hub'
  }, [])
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto max-w-4xl px-4 py-12 md:py-16">
        ...
        <section className="mt-12 flex flex-wrap items-center gap-4 animate-fade-in no-print">
          <TermsDownloadPrintOption contentRef={contentRef} />
        </section>
        ...
        <div className="mt-16 pt-8 border-t border-border flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center animate-fade-in no-print">
          <p className="text-small text-muted-foreground">
            ...
            <a
              href="mailto:legal@creatoropshub.com"
              className="text-primary hover:underline transition-colors"
            >
              legal@creatoropshub.com
            </a>
          </p>
